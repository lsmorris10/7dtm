...
public class ModBlocks {
    ...
    public static final Supplier<Block> MAILBOX_BLOCK = registerWithItem("mailbox",
            () -> new com.sevendaystominecraft.block.loot.MailboxBlock(metalContainerProps("mailbox")));
    ...
    public static final Supplier<Block> TARP_POST = registerWithItem("tarp_post",
            () -> new com.sevendaystominecraft.block.building.TarpPostBlock(BlockBehaviour.Properties.of()
                    .setId(blockKey("tarp_post"))
                    .strength(0.5f)
                    .sound(SoundType.WOOD)
                    .noOcclusion()));

    public static final Supplier<Block> TARP_BLOCK = registerBlock("tarp_block",
            () -> new com.sevendaystominecraft.block.building.TarpBlock(BlockBehaviour.Properties.of()
                    .setId(blockKey("tarp_block"))
                    .strength(0.3f)
    ...
    public static final Supplier<Block> CRT_TV_BLOCK = registerWithItem("crt_tv",
            () -> new CrtTvBlock(BlockBehaviour.Properties.of()
                    .setId(blockKey("crt_tv"))
                    .strength(2.0f)
                    .sound(SoundType.METAL)
                    .noOcclusion()
                    .lightLevel(state -> state.getValue(CrtTvBlock.POWERED) ? 3 : 0)));
