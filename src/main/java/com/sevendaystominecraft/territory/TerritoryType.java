...
public enum TerritoryType {
    ...
    ABANDONED_ESTATE("Abandoned Estate",  LootContainerType.SUPPLY_CRATE, LootContainerType.GUN_SAFE);
    ...
    static {
        ...
        ALLOWED_BUILDINGS.put(ABANDONED_ESTATE, List.of(VillageBuildingType.MANSION));
    }
    ...
    public static TerritoryType randomNonTrader(net.minecraft.util.RandomSource random) {
        ...
        } while (result == TRADER_OUTPOST || result == UNDERGROUND_BUNKER || result == ABANDONED_ESTATE);
        return result;
    }
}
