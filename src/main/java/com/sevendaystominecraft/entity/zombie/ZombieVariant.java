...
public enum ZombieVariant {
    WALKER(20.0, 3.0, 2.3, 200, 1),
    CRAWLER(12.0, 3.8, 0.8, 150, 1),
    FROZEN_LUMBERJACK(30.0, 4.5, 0.9, 250, 1),
    BLOATED_WALKER(40.0, 3.8, 0.7, 300, 3),
    SPIDER_ZOMBIE(24.0, 5.3, 1.8, 300, 5),
    FERAL_WIGHT(60.0, 7.5, 2.5, 350, 7),
    COP(70.0, 5.6, 1.2, 400, 14),
    ...
    NURSE(24.0, 3.8, 1.0, 250, 7),
    SOLDIER(80.0, 9.4, 1.5, 400, 14),
    CHARGED(0, 0, 0, 550, 21),
    INFERNAL(0, 0, 0, 550, 21),
    RADIATED(0, 0, 0, 500, 28),
    BEHEMOTH(400.0, 18.8, 0.8, 2000, 35);
