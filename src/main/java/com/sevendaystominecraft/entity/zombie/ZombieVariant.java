...
public enum ZombieVariant {
    WALKER(20, 1.6, 1.0, 200, 1),
    CRAWLER(12, 2.0, 0.8, 150, 1),
    FROZEN_LUMBERJACK(30, 2.4, 0.9, 250, 1),
    BLOATED_WALKER(40, 2.0, 0.7, 300, 3),
    SPIDER_ZOMBIE(24, 2.8, 1.8, 300, 5),
    FERAL_WIGHT(60, 4.0, 2.5, 350, 7),
    COP(70, 3.0, 1.2, 400, 14),
    SCREAMER(16, 1.0, 1.5, 250, 7),
    ZOMBIE_DOG(16, 3.6, 3.5, 200, 3),
    VULTURE(12, 2.4, 4.0, 200, 7),
    DEMOLISHER(160, 6.0, 1.0, 800, 21),
    MUTATED_CHUCK(50, 3.6, 1.3, 350, 14),
    ZOMBIE_BEAR(120, 7.0, 2.0, 500, 14),
    NURSE(24, 2.0, 1.0, 250, 7),
    SOLDIER(80, 5.0, 1.5, 400, 14),
    CHARGED(0, 0, 0, 550, 21),
    INFERNAL(0, 0, 0, 550, 21),
    RADIATED(0, 0, 0, 500, 28),
    BEHEMOTH(400, 10.0, 0.8, 2000, 35);
