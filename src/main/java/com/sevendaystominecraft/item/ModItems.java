...
public class ModItems {
    ...
    public static final Supplier<Item> COFFEE = ITEMS.register("coffee",
            () -> new ConsumableStatItem(new Item.Properties().setId(key("coffee")).stacksTo(64),
                ...
                public void appendHoverText(net.minecraft.world.item.ItemStack stack, TooltipContext context, java.util.List<net.minecraft.network.chat.Component> tooltip, net.minecraft.world.item.TooltipFlag flag) {
                    ...
                    tooltip.add(net.minecraft.network.chat.Component.literal("§bGrants Speed I (2 min)"));
                }
            });
    ...
    public static final Supplier<Item> TARP_SMALL = ITEMS.register("tarp_small",
            () -> new Item(new Item.Properties().setId(key("tarp_small")).stacksTo(16)) {
                @Override
                public void appendHoverText(net.minecraft.world.item.ItemStack stack, TooltipContext context, java.util.List<net.minecraft.network.chat.Component> tooltip, net.minecraft.world.item.TooltipFlag flag) {
                    tooltip.add(net.minecraft.network.chat.Component.literal("§7Small Tarp — covers up to 3×3 area"));
                    tooltip.add(net.minecraft.network.chat.Component.literal("§7Use on two Tarp Posts to stretch."));
                }
            });

    public static final Supplier<Item> TARP_MEDIUM = ITEMS.register("tarp_medium",
            () -> new Item(new Item.Properties().setId(key("tarp_medium")).stacksTo(16)) {
                @Override
                public void appendHoverText(net.minecraft.world.item.ItemStack stack, TooltipContext context, java.util.List<net.minecraft.network.chat.Component> tooltip, net.minecraft.world.item.TooltipFlag flag) {
                    tooltip.add(net.minecraft.network.chat.Component.literal("§7Medium Tarp — covers up to 6×6 area"));
                    tooltip.add(net.minecraft.network.chat.Component.literal("§7Use on two Tarp Posts to stretch."));
                }
            });

    public static final Supplier<Item> TARP_LARGE = ITEMS.register("tarp_large",
            () -> new Item(new Item.Properties().setId(key("tarp_large")).stacksTo(16)) {
                @Override
                public void appendHoverText(net.minecraft.world.item.ItemStack stack, TooltipContext context, java.util.List<net.minecraft.network.chat.Component> tooltip, net.minecraft.world.item.TooltipFlag flag) {
                    tooltip.add(net.minecraft.network.chat.Component.literal("§7Large Tarp — covers up to 15×15 area"));
                    tooltip.add(net.minecraft.network.chat.Component.literal("§7Use on two Tarp Posts to stretch."));
                }
            });
