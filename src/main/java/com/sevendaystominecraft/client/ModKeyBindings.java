...
public class ModKeyBindings {
    ...
    public static final KeyMapping OPEN_PROGRESSION_TREE = new KeyMapping(
            "key.sevendaystominecraft.open_progression_tree",
            InputConstants.Type.KEYSYM,
    ...
    public static void onRegisterKeyMappings(RegisterKeyMappingsEvent event) {
        ...
        event.register(OPEN_PROGRESSION_TREE);
    }
    ...
    public static void onClientTick(ClientTickEvent.Post event) {
        ...
        while (OPEN_PROGRESSION_TREE.consumeClick()) {
            if (mc.screen instanceof ProgressionTreeScreen) {
                mc.setScreen(null);
            } else if (mc.screen == null || mc.screen instanceof InventoryScreen || mc.screen instanceof BzhsInventoryScreen || mc.screen instanceof BigMapScreen || mc.screen instanceof QuestJournalScreen) {
                mc.setScreen(new ProgressionTreeScreen());
            }
        }
    }
}
