...
public class ModSounds {
    ...
    public static final Supplier<SoundEvent> CRT_POWER_ON = register("crt_power_on");
    public static final Supplier<SoundEvent> CRT_POWER_OFF = register("crt_power_off");
    public static final Supplier<SoundEvent> CRT_STATIC = register("crt_static");
